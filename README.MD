...
[![Go Report Card](https://goreportcard.com/badge/github.com/mustafa-korkmaz/movies)](https://goreportcard.com/report/github.com/mustafa-korkmaz/movies)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/mustafa-korkmaz/movies-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/mustafa-korkmaz/movies` to `$GOPATH/github.com/author/project` and do a global replacement of the string `github.com/mustafa-korkmaz/movies` with `github.com/author/project`.
...
You can log in as admin to the application by sending a post request to localhost:3000/login with username `admin` and password `admin` in JSON body.
